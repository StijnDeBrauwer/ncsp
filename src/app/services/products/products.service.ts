    ...
    this.products = [
      new Product(
        ...
        new Solution(
          ...
          [
            {
              type: SolutionBenefitType.EFFICIENCY,
              description:
                "A new infeed table will restore a reliable loading of the bottles into the bottle washer and reduce stops due to falling bottles or jams. The gentle bottle handling will avoid damaging the bottles."
            },
            {
              type: SolutionBenefitType.SAFETY,
              description:
                "All our assemblies are fully tested in our workshop and comply with all current safety standards as well for operator safety as for product safety."
            },
            {
              type: SolutionBenefitType.COST_SAVING,
              description:
                "Short installation time. Better ecomical solution when current system shows structural defects. Guaranteed availability of spare parts. Comes with renewed product warranty."
            }
          ]
        ),
          ...
          [
            {
              type: SolutionBenefitType.EFFICIENCY,
              description:
                "For a reliables discharge of bottles onto the exit conveyor without stops caused by falling or jammed bottles"
            },
            {
              type: SolutionBenefitType.SAFETY,
              description:
          ...
          [
            {
              ...
              description:
                "Easy access to zone above discharge for efficient cleaning of the clean zone. Glass panel allows continuous visual check of the zone."
            },
            {
              type: SolutionBenefitType.SAFETY,
              description:
            ...
            },
            {
              type: SolutionBenefitType.COST_SAVING,
              description:
                "Short installation time. Avoids longer stops for cleaning."
            }
          ]
        ),
      ...
      new Product(
        ...
        new Solution(
          ...
          [
            {
              type: SolutionBenefitType.WATER_SAVING,
              description:
                "Strongly reduced water and energy consumption because of interrupted water injection and pressure control - no bottle = no water. "
            },
            {
              type: SolutionBenefitType.ENERGY_SAVING,
              description:
                "Water used in the machine extracts heat from the process. When less water is consumed and drained, a lot of energy is therefore saved and remains in the machine."
            },
            {
              type: SolutionBenefitType.QUALITY_HYGIENE,
              description:
                "Highly improved rinsing and cooling of bottles. Slanted and rounded tanks allow a better cleaning and an improved hygiene. Efficient filtration system avoids the blocking of the nozzles hence a constant injection."
            },
            {
              type: SolutionBenefitType.SAFETY,
              description:
                "The closed filtration system and renewed windows protect the operator from contact with hot water."
            },
            {
              type: SolutionBenefitType.COST_SAVING,
              description:
                "The very simple mechanical system with rotating stars will reduce neded time for overhaul and cost of spare parts."
            }
          ]
        ),
          ...
          [
            {
              type: SolutionBenefitType.QUALITY_HYGIENE,
              description:
                "This system prevents the presence of too high caustic concentration in the bottles at the discharge."
            },
            {
              type: SolutionBenefitType.COST_SAVING,
              description:
                "Less bottle explosions at the filler due to high temperature of the bottles"
            }
          ]
        ),
          ...
          [
            {
              type: SolutionBenefitType.QUALITY_HYGIENE,
              description:
                "Strong reduction of label carry over at the discharge of the bottle washer."
            },
            {
              type: SolutionBenefitType.COST_SAVING,
              description:
                "Reduces rejections ath the EBI due to label carry-over."
            }
          ]
        ),
          ...
          [
            {
              type: SolutionBenefitType.WATER_SAVING,
              description:
                "Up to 50% water saving compared to the traditional system with sprayracks, as wter is injected only when the bottle is above the spraybeam."
            },
            {
              type: SolutionBenefitType.ENERGY_SAVING,
              description:
                "With the water saving, a parallel energy saving is realized as the water at the drain is about 20 to 30°C higher than the fresh water at the final rinse."
            },
            {
              type: SolutionBenefitType.QUALITY_HYGIENE,
              description:
                "Since the bottle carrier itself activates the rotation, there is no risk for faulty timing and injection besides the bottle. The injection is always inside the bottle. The system is self-cleaning. As the spraybeam rotates, it is injected one time from one side, the next time from the other side, which means any dirt that could block the nozzle is rjected."
            },
            {
              type: SolutionBenefitType.COST_SAVING,
              description:
                "This simple is a very simple and easy to maintain mechanical system."
            }
          ]
        ),
  ...
  public multiFilter(filters) {
    ...
    filters.forEach(filter => {
      const foundProducts = this.products.filter((product: Product) => {
        if (product.solution) {
          const benefitsTypes = product.solution.benefits.map(
